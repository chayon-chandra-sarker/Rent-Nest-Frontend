...
import type { LandlordProperty } from "@/service/property.service";
import DeletePropertyButton from "./DeletePropertyButton";



const LandlordPropertiesClient = () => {
  ...
  useEffect(() => {
    const handlePropertyDeleted = (event: Event) => {
      const customEvent = event as CustomEvent<string>;

      const deletedPropertyId = customEvent.detail;
        ...
        <div className="flex min-h-[400px] items-center justify-center rounded-3xl border border-border/60 bg-card">
          <div className="max-w-sm text-center">
            ...
            <p className="mt-2 text-sm leading-6 text-muted-foreground">
              You have not added any properties yet. Start by
              creating your first rental property.
            </p>
...
export default LandlordPropertiesClient;
